import torch, evaluate, numpy as np, wandb, os, shutil, time, multiprocessing
...
def predict_trainer(trainer, eval_ds):
    return trainer.predict(test_dataset=eval_ds)

with multiprocessing.Pool(processes=2) as pool:
    async_result1 = pool.apply_async(predict_trainer, (trainer1, eval_ds))
    async_result2 = pool.apply_async(predict_trainer, (trainer2, eval_ds2))

    final1 = async_result1.get()
    final2 = async_result2.get()
